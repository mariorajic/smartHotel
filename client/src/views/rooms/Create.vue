    ...
    <b-row>
      ...
      <b-col class="flex-center">
        <b-form v-on:submit.prevent="createRoom" class="w-75">
          <b-form-group :label-cols-md="4" label="Room name:" label-for="name">
            <b-form-input
              id="name"
              type="text"
              size="sm"
          ...
          <b-form-group :label-cols-md="4" label="Room no.:" label-for="number">
            <b-form-input
              id="number"
              type="number"
              size="sm"
          ...
          >
            ...
            >
              <option selected disabled
                >Please choose the room floor no.</option
              >
...
export default {
  ...
  methods: {
    createRoom: function() {
      axiMara.post("rooms/create", this.room).then((response) => {

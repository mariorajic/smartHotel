<template>
  <b-container fluid v-if="floor">
    <b-row>
      <b-col>
        <router-link :to="{ name: 'floors' }" @click="setEventGetter">
          Back to list of floors
        </router-link>
      </b-col>
      <b-col
        md="12"
        class="align-items-center justify-content-center text-center py-2"
      >
    ...
    <b-row class="buttonsRow">
      ...
      >
        ...
        <b-row>
          <b-col
            v-if="room.occupied_from"
            cols="6"
            class="roomOcc text-center flex-center"
            v-on:click="goToRoom2(room)"
          >
            <p>
              <br />
              <br />
          ...
          <b-col
            v-else
            cols="6"
            class="roomFree text-center flex-center"
            v-on:click="goToRoom2(room)"
          >
            <p>
              <br />
          ...
          <b-col cols="2">
            <b-row>
              <b-col class="py-2">
                ...
                <b-img
                  v-if="room.key_status"
                  :src="require('../../assets/img/cardIn.png')"
                  fluid
                  alt="IN"
                />
                <b-img
                  v-else
                  :src="require('../../assets/img/cardOut.png')"
                  fluid
                  alt="OUT"
                />
              </b-col>
            ...
            <b-row>
              <b-col class="py-2">
                ...
                <b-img
                  v-if="room.door_status"
                  :src="require('../../assets/img/doorClosed.png')"
                  fluid
                  alt="CLOSED"
                />
                <b-img
                  v-else
                  :src="require('../../assets/img/doorOpen.png')"
                  fluid
                  alt="OPEN"
                />
              </b-col>
            ...
            <b-row>
              <b-col class="py-2">
                ...
                <b-img
                  v-if="room.window_status"
                  :src="require('../../assets/img/winClosed.png')"
                  fluid
                  alt="CLOSED"
                />
                <b-img
                  v-else
                  :src="require('../../assets/img/winOpen.png')"
                  fluid
                  alt="OPEN"
                />
              </b-col>
          ...
          <b-row class="flex-center w-100">
            <b-col
              cols="12"
              v-if="room.occupied_from"
              class="flex-center align-items-center w-100"
            >
              <p>
                {{ room.occupied_from | moment("DD. MMM.") }} -
                {{ room.occupied_to | moment("DD. MMM.") }} -
...
export default {
  ...
  methods: {
    ...
    deleteFloor() {
      axiMara.post("floors/deleteById", this.floor).then((response) => {
    ...
    createBooking: function() {
      ...
      this.booking.range.end = this.$moment(this.booking.range.end)
        .startOf("day")
        .subtract(1, "days")
        .toDate();
      axiMara
        ...
        .then((response) => {
          this.booking.range.start = this.$moment()
            .startOf("day")
            .toDate();
          this.booking.range.end = this.$moment()
            .startOf("day")
            .add(2, "days")
            .toDate();
